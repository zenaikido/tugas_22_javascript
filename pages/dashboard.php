        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <?php
                    global $link;
                    $sql = mysqli_query($link, "SELECT * FROM mr a WHERE mpr_status=0 && deleted_status=0");
                    $row = mysqli_num_rows($sql);
                    ?>
                    <div class="info-box-content">
                        <span class="info-box-text">MPR Approved</span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    <span class="info-box-icon bg-red"><i class="fa fa-pause-circle-o"></i></span>
                    ...
                    ?>
                    <div class="info-box-content">
                        <span class="info-box-text">MPR Need to Approve</span>
                        <span class="info-box-number"><?php echo $row; ?></span>
                        <a href="?page=pending-material-purchase-request">
                            <button class="btn btn-rounded btn-info fa fa-info-circle"> Details</button>
                        </a>
                    </div>
                </div>
            </div>
