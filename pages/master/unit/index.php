						...
						<tbody>
							<tr>
								...
								if ($row == "") {
									...
									$query = mysqli_query($link, "SELECT * FROM master_unit WHERE deleted_status=0 ORDER BY unit ASC");
								...
								?>
										...
										<td>
											<?php if ($_SESSION['access'] != "View") { ?>
												<a href="?page=page-edit-unit&slug=<?= $data['slug']; ?>">
...
<form action="?page=add-unit" method="POST">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" style="text-align: center;">Add Data Unit</h4>
				</div>
				<div class="modal-body">
					<div class="form-group row">
						<label class="col-sm-2 col-form-label">Unit</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" name="unit" placeholder="Pcs" required>
						</div>
					</div>
		...
		swal({
			...
			.then((willDelete) => {
				if (willDelete) {
					...
					var location = "?page=delete-unit&slug=" + slug;
