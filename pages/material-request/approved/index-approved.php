<section class="content-header">
    <h1>
        Approved Material Purchase Request
    </h1>
    <ol class="breadcrumb">
            ...
            <div class="box-tools pull-right">
                <div class="title-action">
                    <?php if ($_SESSION['access'] != "View") { ?>
                        <a href="?page=page-add-material-purchase-request" class="btn btn-success">Add Data</a>
                    <?php } ?>
                </div>
            </div>
        </div>
                ...
                <div class="table-responsive">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            $sql = mysqli_query(
                                $link,
                                "SELECT a.mr_no,b.abbreviation,c.supplier,c.currency_code,d.product,a.qty,a.unit_price,f.unit,a.remarks
                               FROM mr_detail a
                                ...
                                WHERE e.mpr_status=0 AND e.deleted_status=0 
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $data['currency_code']; ?> <?= number_format($data['unit_price'], 2, ",", "."); ?></td>
                                    <td><?php echo strtoupper($data['remarks']); ?></td>
                                    <td>
                                        <a href="?page=detail-approved-of-material-purchase-request&detail=<?= $data['mr_no'] ?>">
