<section class="content-header">
    <h1>
        Restore Approved Material Purchase Request
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Restore Approved MPR</li>
    </ol>
</section>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <tr>
								...
								WHERE g.mpr_status=0 AND g.deleted_status=1
                                ...
                                ?>
                                    ...
                                    <td>
                                        <?php if ($_SESSION['access'] != "View") { ?>
                                            <a href="?page=process-restore-approved-material-purchase-request&no=<?= $data['mr_no']; ?>">
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    var location = "?page=permanent-delete-restore-approved-material-purchase-request&mr_no=" + mr_no;
